    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                {/* Security Info Panel */}
                <div className="bg-green-50 border-l-4 border-green-400 p-4 text-green-700 rounded-2xl">
                    <div className="flex items-center">
                        ...
                        <div>
                            <p className="text-sm font-medium">
                                {t("signingIn.securityTip", "Security recommendation")}
                            </p>
                            <p className="text-sm mt-1">
                                {t("signingIn.securityTip.description", "Enable two-factor authentication for enhanced account security. Use multiple authentication methods when possible.")}
                            </p>
                        </div>
                    </div>
                </div>
