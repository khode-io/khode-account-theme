                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <h3 className="text-sm font-medium text-blue-800">
                                {t("personalInfo.infoTitle", "About your personal information")}
                            </h3>
                            <div className="mt-2 text-sm text-blue-700">
                                <p>
                                    {t("personalInfo.infoDescription", "This information will be used to personalize your experience and may be shared with applications you authorize.")}
                                </p>
                            </div>
                        </div>
                    </div>
